            ...
            foreach ($items as $grid_id => $grid) {
                ...
                foreach ($blocks[$grid_id] as $block_id => $block) {
                    ...
                    if (!empty($block_schema['content'])) {
                        ...
                        //Changs Ecarter Start
                        if (isset($content_variables['items'])){
                            $content_variables['items'] = array_values($content_variables['items']);
                        }
                        if (isset($content_variables['brands'])){
                            $content_variables['brands'] = array_values($content_variables['brands']);
                        }
                        //Changs Ecarter End
