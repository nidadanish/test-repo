...
if (defined('PAYMENT_NOTIFICATION')) {
    if ($mode == 'return') {
        ...
        // fn_print_die('return',$_REQUEST);
        if (isset($_REQUEST['transaction_id']) && !empty($_REQUEST['transaction_id']) && isset($_REQUEST['req_reference_number']) && !empty($_REQUEST['req_reference_number'])) {
    ...
    $post['merchant_defined_data3']=$category;
