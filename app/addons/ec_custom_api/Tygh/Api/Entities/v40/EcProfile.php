...
/**
 * Class EcProfile provides means to read and update current user profile or create the new one.
 *
 * @package Tygh\Api\Entities\v40
 */
class EcProfile extends Users
{
    ...
    public function __construct(array $auth = [], $area = '')
    {
        ...
        /** @var \Tygh\Addons\EcCustomApi\ProfileFields\Manager manager */
        $this->manager = Tygh::$app['addons.ec_custom_api.profile_fields.customer_manager'];
