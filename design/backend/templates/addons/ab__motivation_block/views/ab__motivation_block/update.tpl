...
<div class="controls">
<input type="hidden" name="motivation_item_data[expanded]" value="{"YesNo::NO"|enum}" />
<input type="checkbox" name="motivation_item_data[expanded]" id="ab__mb_expanded" value="{"YesNo::YES"|enum}"{if $motivation_item_data.expanded == "YesNo::YES"|enum} checked="checked"{/if} />
</div>
</div>
