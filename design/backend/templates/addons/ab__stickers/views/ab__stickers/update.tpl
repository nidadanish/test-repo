...
<div class="control-group">
{$href = "customization.update_mode?type=theme_editor&status=enable&s_layout=`$runtime.layout.layout_id`&s_storefront=`$app['storefront']->storefront_id`"|fn_url}
...
<p class="muted description">{__("ab__stickers.use_theme_presets.tooltip", ["[href]" => $href])}</p>
</div>
</div>
<div class="control-group">
<label class="control-label cm-color" for="ab__stickers_text_color">{__("ab__stickers.text_color")}:</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label cm-color" for="ab__stickers_sticker_bg">{__("ab__stickers.sticker_bg")}:</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label cm-color" for="ab__stickers_border_color">{__("ab__stickers.border_color")}:</label>
<div class="controls">
...
<div class="sticker-type-settings{if $sticker_data.style|default:$text_style != $graphic_style} hidden{/if}" id="{$graphic_style}_sticker_settings">
<div class="control-group">
<label class="control-label" for="ab__stickers_img">{__("image")}:</label>
<div class="controls">
{include file="common/attach_images.tpl" image_name="ab__sticker_img" image_object_type="ab__stickers" hide_titles=true image_pair=$sticker_data.main_pair no_detailed=true}
</div>
</div>
<div class="control-group">
...
{if $id && $sticker_type == $constant_type}
<li class="divider"></li>
<li>{btn type="list" text=__("ab__stickers.generate.generated_ids.description", [1]) class="cm-post cm-comet cm-ajax" href="ab__stickers.generate.`$id`?storefront_ids=`$app['storefront']->storefront_id`" method="GET"}</li>
{/if}
{/capture}
