...
<div class="control-group control-group1">  
    <label class="control-label">{__("wk_cybersource_mode_3ds")}:{include file="common/tooltip.tpl" tooltip={__("wk_cybersource_mode_3ds_tooltip")}}</label>
    <div class="controls">
      <label class="checkbox inline" for="elm_id_buy_now"><input type="checkbox" id="elm_id_buy_now" name="payment_data[processor_params][wk_cybersource_secure]" value="Y" {if $processor_params.wk_cybersource_secure == "Y"}checked="checked"
       {/if}/></label>
    </div>
</div>
