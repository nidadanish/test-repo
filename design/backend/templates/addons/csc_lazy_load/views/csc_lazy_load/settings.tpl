...
{include file="common/mainbox.tpl" title=__($addon_base_name) content=$smarty.capture.mainbox buttons=$smarty.capture.buttons  content_id="`$addon_base_name`_settings" mainbox_content_wrapper_class="csc-settings" sidebar=$smarty.capture.sidebar}